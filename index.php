...
<body style=background-color:rgb(237,240,242)>
      ...
      <ul id="flex-menus">
        ...
        <li id="hovermenu" class="menu-deroulant">SERVICES
          <div class="ssmenu togglebox">
            <ul class="sousmenu">
              <li class="toglecontent"><a href="#"><img class="logos-sousmenu" src="Assets/logoweb.png" alt="logo developpement web">DÉVELOPPEMENT WEB</a></li>
              <li class="toglecontent"><a href="#"><img class="logos-sousmenu" src="Assets/logographique.png" alt="logo creation graphique">CRÉATION GRAPHIQUE</a></li>
              <li class="toglecontent"><a href="#"><img class="logos-sousmenu" src="Assets/logocommunity.png" alt="logo community management">COMMUNITY MANAGER</a></li>
            </ul>
          </div>
        </li>
  ...
  <div class="flex-container" id="div-contact">
    ...
    <div class="contact-texte">
      ...
      <p class="horraire-semaine"> Lundi 9H-12H <br>du mardi au vendredi<br> 9H-17H30</p>
    </div>
  ...
  <footer>
    ...
    <div class="flex-container" id="div-footer">
      <div >
        <img id="logo-footer" alt="Logo complet de l'entreprise Pix'ncom" src="Assets/LOGO-RVB.png" >
      </div>
